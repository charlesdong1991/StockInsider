...
KTYPE_CONVERSION = {"D": "akdaily", "W": "akweekly", "M": "akmonthly"}  # Conversion for the type of K-lines for URL
KTYPES = ["D", "W", "M"]  # Allowed types of K-lines
DAY_COL = ["day"]  # date column from fetched dataset
NUMERIC_COLUMNS = ["open", "high", "close", "low", "volumn", "price_change",
                   "percent_change", "ma5", "ma10", "ma20", "v_ma5", "v_ma10", "v_ma20"]  # all numeric columns from fetched dataset
